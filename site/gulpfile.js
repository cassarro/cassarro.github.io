...
(function () {
    ...
    =============================
    */
    var File_Name = 'jekyll-resume.zip';
    var CSS_Files = [
    ...
    var JS_Files = [
        ...
        './assets/js/jquery-migrate-1.12.0.min.js',
    ...
    var Production_JS_Files = [
        './dist/production/assets/js/jquery-3.5.1.min.js',
        './dist/production/assets/js/jquery-migrate-1.12.0.min.js',
        './dist/production/assets/js/jquery.easing.1.3.js',
        './dist/production/assets/js/bootstrap.min.js',
        './dist/production/assets/js/isotope.min.js',
        './dist/production/assets/js/waypoints.min.js',
